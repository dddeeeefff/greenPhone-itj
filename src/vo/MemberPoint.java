...
public class MemberPoint {
	...
	private int mp_idx, mp_point, mp_admin, mp_changePoint;
	public int getMp_changePoint() {
		return mp_changePoint;
	}
	public void setMp_changePoint(int mp_changePoint) {
		this.mp_changePoint = mp_changePoint;
	}
