...
String sdidx = request.getParameter("sdidx");
%>
<style>
.main {	font-size: 20px; }
...
<article class="main">
<h3 class="main_title">리뷰 작성</h3>
	<form name="frmJoin" action="review_proc" method="post">
	<input type="hidden" name="sdidx" value="<%=sdidx %>">
		<ul class="write">
			<li class="">
		...
		<div class="btn_wrap">
			...
			<input class="yes_btn_bg" type="submit" value="리뷰 등록" />
		</div>
	</form>
</article>
</section>
